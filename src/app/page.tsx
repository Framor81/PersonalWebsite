...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* MAIN CONTENT */}
      <div 
        className={`w-full lg:w-[calc(100%-13rem)] lg:ml-52 viewport-scaled ${snapMode ? "snap-y snap-mandatory" : ""}`}
      >
          ...
          <div className={`max-w-5xl w-full space-y-4`} style={{ marginLeft: 'var(--content-offset-left)' }}>
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold !text-yellow-600">
                Accenture &mdash; Tech Architecture Summer Analyst
              </h3>
              <p className="text-zinc-400 text-sm italic">Austin, Texas &middot; June 2025 &ndash; August 2025</p>
              <ul className="list-disc list-inside text-zinc-300 leading-snug space-y-1">
                <li>
                  Engineered real-time monitoring dashboards in Grafana to visualize application 
                  health, JVM performance, and API usage by integrating Prometheus, Loki, 
                  and InfluxDB with their respective query languages.
                </li>
                <li>
                  Designed end-to-end architectural decisions, evaluating trade-offs across scalability, 
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold !text-yellow-600">
                Accenture &mdash; Technology Consulting Analyst Intern
              </h3>
              <p className="text-zinc-400 text-sm italic">Austin, Texas &middot; June 2024 &ndash; August 2024</p>
              <ul className="list-disc list-inside text-zinc-300 leading-snug space-y-1">
                <li>
                  Developed Anaplan models alongside a 12-person team of consultants and developers, 
                  aligning business workflows with client needs while managing Agile sprints, 
                  user stories, and JIRA tasks.
                </li>
                <li>
                  Optimized reporting pipelines using advanced Excel automation and 
                  produced clear, data-driven presentation decks for executive audiences.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold !text-yellow-600">
                Pomona College &mdash; Teaching Assistant
              </h3>
              <p className="text-zinc-400 text-sm italic">Claremont, CA &middot; January 2024 &ndash; Present</p>
              <ul className="list-disc list-inside text-zinc-300 leading-snug space-y-1">
                <li>
                  Facilitated code reviews and reinforced core concepts in object-oriented 
                  programming and data structures for 85+ students across multiple course offerings.
                </li>
                <li>
                  Supported students in Discrete &amp; Functional Programming (CSCI054) by 
                  teaching Haskell fundamentals, leading study sessions, and providing targeted 
                  guidance on complex theoretical material.
                </li>
              </ul>
            </div>

            {/* ARCS Research Assistant */}
            <div className="space-y-1">
              <h3 className="text-2xl font-semibold !text-yellow-600">
                Pomona College &mdash; ARCS Laboratory Research Assistant
              </h3>
              <p className="text-zinc-400 text-sm italic">Claremont, CA &middot; June 2023 &ndash; Present</p>
              <ul className="list-disc list-inside text-zinc-300 leading-snug space-y-1">
                <li>
                  Built precise robotic simulation environments in Unreal Engine 5 and Blender, 
                  leading Blueprint scripting and integrating Python through a custom OSC plugin 
                  for real-time data streaming, navigation control, and model training.
                </li>
                <li>
                  Engaged with scholarly research and leveraged PyTorch and FastAI to improve 
                  model performance from 22% accuracy to 61.2% through iterative experimentation, 
                  augmentation pipelines, and architecture refinement.
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          <div className={`max-w-5xl w-full space-y-4`} style={{ marginLeft: 'var(--content-offset-left)' }}>
            ...
            <ul className="list-disc list-inside text-zinc-300 leading-7 space-y-2">
              <li>
                <strong>ACM Student Research Competition (Undergraduate Division), 3rd Place</strong> — 2025 Tapia Conference
              </li>
